...
const authLimiter = createRateLimit({
  ...
  skip(req) {
    ...
    return email.endsWith('@loom-demo.local')
  },
})
...
app.post('/send-otp', authLimiter, asyncHandler(authController.sendOtp))
app.post('/verify-otp', authLimiter, asyncHandler(authController.verifyOtp))
app.post('/api/auth/send-otp', authLimiter, asyncHandler(authController.sendOtp))
app.post('/api/auth/verify-otp', authLimiter, asyncHandler(authController.verifyOtp))
app.post('/api/auth/verify-email', authLimiter, asyncHandler(authController.verifyEmail))
...
app.patch('/api/protected/me', authRequired, trackActivity, asyncHandler(authController.updateProfile))
...
app.get('/api/assets', authRequired, trackActivity, requireRoles('user', 'nominee', 'admin'), asyncHandler(assetController.listAssets))
app.get('/api/vault/nominee', authRequired, trackActivity, requireRoles('user', 'nominee', 'admin'), asyncHandler(vaultController.listNomineeVaults))
app.get('/vault/nominee', authRequired, trackActivity, requireRoles('user', 'nominee', 'admin'), asyncHandler(vaultController.listNomineeVaults))
...
app.patch('/api/assets/:assetId', authRequired, trackActivity, requireRoles('user', 'admin'), requireRecentMfa, asyncHandler(assetController.updateAsset))
app.delete('/api/assets/:assetId', authRequired, trackActivity, requireRoles('user', 'admin'), requireRecentMfa, asyncHandler(assetController.deleteAsset))
